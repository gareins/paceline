...
files=("sha1.js" "sha256.js" "sha512.js" "ripemd160.js" "md5.js")
...
curl $src > "$out_fold""jquery.min.js"
...
curl $src -L -o /tmp/scrollbar.zip

unzip -p /tmp/scrollbar.zip css/perfect-scrollbar.min.css > "$out_fold""scroll/perfect-scrollbar.min.css"
unzip -p /tmp/scrollbar.zip js/min/perfect-scrollbar.jquery.min.js > "$out_fold""scroll/perfect-scrollbar.jquery.min.js"
